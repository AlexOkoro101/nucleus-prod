        ...
        <div className="buy-cover mt-24 font-primary">
            <div className="text-center">
                ...
                <div className="flex flex-col lg:flex-row justify-around lg:gap-20 gap-10 lg:px-80 px-8 lg:mb-44 mb-14">
                    <div className="w-full">
                        <div className="w-full h-48  rounded-3xl overflow-hidden">
                            <img src={buycover1} alt="buycover"  className="inline-block h-full w-full object-cover" />
                        </div>
                    ...
                    <div className="w-full">
                        <div className="w-full h-48  rounded-3xl overflow-hidden">
                            <img src={buycover2} alt="buycover"  className="inline-block h-full w-full object-cover" />
                        </div>
                ...
                <div className="flex flex-col lg:flex-row justify-around lg:gap-20 gap-10 lg:px-80 px-8 mb-14">
                    <div className="w-full">
                        <div className="w-full h-48  rounded-3xl overflow-hidden">
                            <img src={buycover3} alt="buycover"  className="inline-block h-full w-full object-cover" />
                        </div>
                    ...
                    <div className="w-full">
                        <div className="w-full h-48  rounded-3xl overflow-hidden">
                            <img src={buycover4} alt="buycover"  className="inline-block h-full w-full object-cover" />
                        </div>
