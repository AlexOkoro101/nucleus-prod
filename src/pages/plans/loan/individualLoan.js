                            ...
                            <form onSubmit={handleSubmit(submitForm)}>
                                ...
                                <div className="mb-10">
                                    <div className="flex flex-col flex-1">
                                        ...
                                        <select value={loanDuration} onChange={(e) => setloanDuration(e.target.value)} className="input-primary px-6 focus:outline-none lg:w-1/3 w-full">
                                ...
                                <div>
                                    ...
                                    <table className="table-fixed w-full hidden md:block">
                                        <tbody className="w-full table">
                                            ...
                                            <tr>
                                                <td className="p-4 border border-gray-200"><span className="color-primary font-semibold md:text-lg text-base">Phone Number</span>  <br /> <span className="text-black font-medium text-lg">{phone}</span> </td>
                                                <td className="p-4 border border-gray-200"><span className="color-primary font-semibold md:text-lg text-base">Address</span>  <br /> <span className="text-black font-medium text-lg">{address}</span> </td>
                                                <td className="p-4 border border-gray-200"><span className="color-primary font-semibold md:text-lg text-base">Loan Duration</span>  <br /> <span className="text-black font-medium text-lg">{loanDuration} Month(s)</span> </td>
                                            </tr>
                                            <tr className="bg-gray-300">
                                                <td className="p-3 font-semibold text-lg" colSpan="3">Hospital Details</td>
                                            </tr>
